        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pilots",
                    models.ManyToManyField(
                        blank=True, related_name="vehicles", to="resources.People"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pilots",
                    models.ManyToManyField(
                        blank=True, related_name="starships", to="resources.People"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "characters",
                    models.ManyToManyField(
                        blank=True, related_name="films", to="resources.People"
                    ),
                ),
                (
                    "planets",
                    models.ManyToManyField(
                        blank=True, related_name="films", to="resources.Planet"
                    ),
                ),
                (
                    "species",
                    models.ManyToManyField(
                        blank=True, related_name="films", to="resources.Species"
                    ),
                ),
                (
                    "starships",
                    models.ManyToManyField(
                        blank=True, related_name="films", to="resources.Starship"
                    ),
                ),
                (
                    "vehicles",
                    models.ManyToManyField(
                        blank=True, related_name="films", to="resources.Vehicle"
                    ),
                ),
            ],
            options={
