...
class TestAllEndpoints(TestCase):
    ...
    def test_people_schema(self):
        self.assertEqual(self.get_query("/api/people/schema").status_code, 200)
    ...
    def test_planets_schema(self):
        self.assertEqual(self.get_query("/api/planets/schema").status_code, 200)
    ...
    def test_films_schema(self):
        self.assertEqual(self.get_query("/api/films/schema").status_code, 200)
    ...
    def test_starship_schema(self):
        self.assertEqual(self.get_query("/api/starships/schema").status_code, 200)
    ...
    def test_vehicle_schema(self):
        self.assertEqual(self.get_query("/api/vehicles/schema").status_code, 200)
    ...
    def test_species_schema(self):
        self.assertEqual(self.get_query("/api/species/schema").status_code, 200)
    ...
    def test_etag(self):
        ...
        self.assertEqual(self.get_query("/api/").status_code, 304)
